 ...
 「 رابط دخول لمملكة ستارك」◣
		    ...
		    「 الكل ينضم 」◣`,
                    ...
                    sections: [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "قائمة استمارات مملكة ستارك",
										"description": ".17.",
										"rowId": `${prefix}anon`
									}
								]
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
            ...
            case 'التسجhgjيل': case 'التسجيل': {
                reply(`「 قوانين ومتجر مملكة ستارك」◣

「 _http://5f77c978c4264.site123.me_ 」◣
...
await GojoMdNx.send5ButImg(from, `` + '' + ' ', `مملكة ستارك تضم حوالي 9 نقابة من افضل الممالك بقيادة ايتاتشي والمستشار انوس اما انا مجرد بوت كيف تشوفوني ؟ ههه مو مشكلة المهم انوس يقول اذا بدكم تنضمون معنا اضغطو ع زر رابط الاستقبال.`,unicorn, [{"urlButton": {"displayText": "「 قناتي 」「📍」◣","url": `${myweb}`}},{"urlButton": {"displayText": "「 رابط الاستقبال 」「📌」◣","url": `${sc}`}},{"quickReplyButton": {"displayText": "「 الاستلام 」「🍜」◣","id": 'donate'}},{"quickReplyButton": {"displayText": "「 المالك 」「👤」◣","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
